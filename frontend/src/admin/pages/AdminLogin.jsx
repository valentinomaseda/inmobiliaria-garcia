        ...
        <div className="bg-jo-darkSurface rounded-2xl shadow-premium-dark p-6 sm:p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-jo-pink hover:bg-jo-pinkHover text-jo-dark font-medium py-3 px-6 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
