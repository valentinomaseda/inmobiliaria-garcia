      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8" data-aos="fade-left" data-aos-duration="600" data-aos-delay="100">
            ...
            {/* Precio */}
            <div 
              className="bg-gradient-to-br from-jo-pink to-orange-500 text-jo-dark p-8 rounded-2xl shadow-xl"
              data-aos="zoom-in"
              data-aos-delay="200"
            >
            ...
            >
              ...
              <a 
                href="#contacto"
                className="w-full flex items-center justify-center gap-3 px-8 py-4 bg-jo-pink hover:bg-jo-pinkHover text-jo-dark rounded-full font-semibold transition-colors shadow-lg"
              >
