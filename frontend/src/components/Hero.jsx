    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8 py-20 sm:py-28 md:py-32 pb-32 md:pb-40">
        ...
        >
          <a 
            href="#propiedades" 
            className="w-full sm:w-auto px-8 py-4 bg-primary text-white rounded-full font-medium hover:bg-primary/90 transition-colors shadow-lg shadow-primary/25"
          >
            Ver Propiedades
          </a>
          <a 
            ...
            target="_blank" 
            rel="noreferrer" 
            className="w-full sm:w-auto px-8 py-4 bg-white text-textDark border border-gray-200 rounded-full font-medium hover:bg-gray-50 transition-all flex items-center justify-center gap-2"
          >
      ...
      <a 
        href="#propiedades" 
        className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce text-primary hover:text-primary/90 transition-colors z-10"
