...
export default function Hero() {
  return (
    ...
    >
      {/* Overlay más oscuro para mejorar contraste con texto claro */}
      <div className="absolute inset-0 bg-gradient-to-br from-black/50 via-black/30 to-transparent"></div>

      {/* Contenido */}
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-6 py-12 sm:py-16 md:py-20">
        <h1
          className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-extrabold tracking-tight leading-tight text-white"
          data-aos="fade-down"
          data-aos-delay="100"
        >
        ...
        <p
          className="text-base sm:text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-medium leading-relaxed px-2"
          data-aos="fade-up"
          data-aos-delay="200"
        >
