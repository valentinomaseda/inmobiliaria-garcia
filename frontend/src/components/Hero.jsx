    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8 py-20 sm:py-28 md:py-32 pb-32 md:pb-40">
        ...
        >
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-yellow-500 drop-shadow-lg">
        ...
        >
          <a 
            href="#propiedades" 
            className="w-full sm:w-auto px-8 py-4 bg-jo-pink text-jo-dark rounded-full font-medium hover:bg-jo-pinkHover transition-colors shadow-lg shadow-jo-pink/25"
          >
            Ver Propiedades
          </a>
          <a 
            ...
            target="_blank" 
            rel="noreferrer" 
            className="w-full sm:w-auto px-8 py-4 bg-white text-jo-dark border border-jo-border rounded-full font-medium hover:border-green-500 hover:bg-gray-50 transition-all flex items-center justify-center gap-2"
          >
