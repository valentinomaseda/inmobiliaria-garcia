        ...
        >
          ...
          <div className="pt-4">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center gap-3 px-10 py-5 bg-jo-pink hover:bg-jo-pinkHover text-jo-dark text-lg font-semibold rounded-full transition-all shadow-2xl shadow-jo-pink/30 hover:shadow-jo-pink/50 hover:scale-105 group"
            >
